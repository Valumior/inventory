...
class AddressTable(tables.Table):
	details = tables.LinkColumn('addressDetails', kwargs={ 'pk' : A('pk') }, orderable=False, text='Szczegoly', empty_values=(), attrs={ 'a' :  { 'class' : 'btn btn-default' }})
	edit = tables.LinkColumn('editAddress', kwargs={ 'pk' : A('pk') }, orderable=False, text='Edytuj', empty_values=(), attrs={ 'a' :  { 'class' : 'btn btn-default' }})
...
class EntryTable(tables.Table):
	signing = tables.LinkColumn('entryDetails', kwargs={ 'pk' : A('getURL') }, attrs={ 'a' :  { 'class' : 'btn btn-default' }})
	room = tables.LinkColumn('roomDetails', kwargs={ 'pk' : A('room.id') }, attrs={ 'a' :  { 'class' : 'btn btn-default' }})
...
class RoomTable(tables.Table):
	room_id = tables.LinkColumn('roomDetails', kwargs={ 'pk' : A('pk') }, attrs={ 'a' :  { 'class' : 'btn btn-default' }})
	edit = tables.LinkColumn('editRoom', kwargs={ 'pk' : A('pk') }, orderable=False, text='Edytuj', empty_values=(), attrs={ 'a' :  { 'class' : 'btn btn-default' }})
...
class UserPermissionsTable(tables.Table):
	user = tables.LinkColumn('userDetails', kwargs={ 'pk' : A('user.id') }, attrs={ 'a' :  { 'class' : 'btn btn-default' }})
...
class InventoryOrderTable(tables.Table):
	details = tables.LinkColumn('inventoryOrderReports', kwargs={ 'pk' : A('pk') }, orderable=False, text='Szczegoly', empty_values=(), attrs={ 'a' :  { 'class' : 'btn btn-default' }})
