...
class EntryTable(tables.Table):
	...
	selected = tables.CheckBoxColumn(accessor='signing', orderable=False)
	
	class Meta:
		model = Entry
		fields = ('signing', 'name', 'date_added', 'added_value', 'date_removed', 'removed_value', 'room', 'short_description', 'last_modified', 'selected')
		attrs = table_attrs
