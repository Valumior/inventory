...
class UserSettings(models.Model):
	...
	qr_columns = models.PositiveIntegerField(default=3)
	qr_width = models.DecimalField(max_digits=5, decimal_places=2, default=70)
	qr_height = models.DecimalField(max_digits=5, decimal_places=2, default=37)
	qr_img_offset = models.DecimalField(max_digits=5, decimal_places=2, default=15)
