...
urlpatterns = [
    ...
    url(r'^liquidation/note/(?P<pk>\d+)/edit/$', ManagerViews.liquidationNoteEdit, name='liquidationNoteEdit'),
    url(r'^liquidation/note/(?P<pk>\d+)/remove/$', ManagerViews.liquidationNoteRemove, name='liquidationNoteRemove'),
